...
class LensTests extends FunSuite with Matchers {
  ...
  test("Expected array lens test") {
    ...
    val withSome = Json("value" -> jArrayElements(jNumberOrNull(1),jNumberOrNull(2),jNumberOrNull(3)), "value2" -> jArrayElements(jNumberOrNull(2)))
    val withNone = Json("value2" -> jArrayElements(jNumberOrNull(2)))
    ...
    ExpTest.value.$at(2).$set(5)(withSome) should be (Json("value" -> jArrayElements(jNumberOrNull(1),jNumberOrNull(2),jNumberOrNull(5)), "value2" -> jArrayElements(jNumberOrNull(2))))
    ExpTest.value.$at(6).$set(5)(withSome) should be (Json("value" -> jArrayElements(jNumberOrNull(1),jNumberOrNull(2),jNumberOrNull(3), jNull, jNull, jNull, jNumberOrNull(5)), "value2" -> jArrayElements(jNumberOrNull(2))))

    ExpTest.value.$append(4)(withSome) should be (Json("value" -> jArrayElements(jNumberOrNull(1),jNumberOrNull(2),jNumberOrNull(3),jNumberOrNull(4)), "value2" -> jArrayElements(jNumberOrNull(2))))
    ExpTest.value.$append(4)(withNone) should be (Json("value" -> jArrayElements(jNumberOrNull(4)), "value2" -> jArrayElements(jNumberOrNull(2))))

    ExpTest.value.$prepend(0)(withSome) should be (Json("value" -> jArrayElements(jNumberOrNull(0),jNumberOrNull(1),jNumberOrNull(2),jNumberOrNull(3)), "value2" -> jArrayElements(jNumberOrNull(2))))
    ExpTest.value.$prepend(0)(withNone) should be (Json("value" -> jArrayElements(jNumberOrNull(0)), "value2" -> jArrayElements(jNumberOrNull(2))))
  }
}
